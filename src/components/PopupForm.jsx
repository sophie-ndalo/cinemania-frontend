...
{isLogin ? (
<button style={{ display: 'block', width: '100%', padding: '5px', backgroundColor: '#007bff', color: '#fff', border: 'none', borderRadius: '3px' }} type="submit">Log in</button>
) : (
<button style={{ display: 'block', width: '100%', padding: '5px', backgroundColor: '#007bff', color: '#fff', border: 'none', borderRadius: '3px' }} type="submit">Sign up</button>
)}
</form>
